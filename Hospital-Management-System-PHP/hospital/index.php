        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    ...
                    <img src="logo.png" alt="" srcset="" style="max-width: 100%; height: auto; max-height: 50px;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="psy1.jpg" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Soins Personnalisés pour une Santé Mentale Équilibrée</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="psy2.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Bienvenue chez Tranquilité Mentale : Un Espace de Guérison Émotionnelle</h5>
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Meeting</button>
            <button class="btn btn-default filter-button" data-filter="sprinkle">Online</button>
            <button class="btn btn-default filter-button" data-filter="spray"> Office</button>
            <button class="btn btn-default filter-button" data-filter="irrigation">Meeting date</button>
        </div>
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="meeting1.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="online2.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="meeting2.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="mdate.jpg" class="img-responsive">
            </div>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="office2.jpg" class="img-responsive">
            </div>
